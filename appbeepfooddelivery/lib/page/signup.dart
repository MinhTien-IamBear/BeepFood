      ...
      try{
        ...
        if(e.code == 'weak-password'){
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            content: Text("Mật Khẩu cung cấp quá yếu", 
          ...
          Container(
            ...
            child: Column(children: [
                ...
                child: Container(
                  ...
                  child: Form(
                    ...
                    child: Column(children: [
                      ...
                      Text("Đăng Ký", style: AppWidget.HeadlineTextFeildStyle()),
              ...
              GestureDetector(
                ...
                child: Text("Bạn đã có tài khoản? Đăng Nhập", style: AppWidget.semiBoldTextFeildStyle(),)),
            ],),
          )
      ],),),
    );
